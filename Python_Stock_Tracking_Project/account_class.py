...
# -*- coding: utf-8 -*-
"""
Created on Sat Mar 23 12:15:15 2024
Ibrahima Diallo 
CEIS150 - Module 3
"""
from stock_class import Stock

#create parent class using Inheritance
class Retirement_Account:
    def __init__(self,balance, number):
        self.balance = balance
        self.number = number

#Create Traditional account class that inherits from the parent (Retirement_Account)
...
##Create Robo account class that inherits from the parent (Retirement_Account)
