...
# -*- coding: utf-8 -*-
"""
Created on Sat Mar 16 23:17:59 2024
...
def display_chart(stock_list):
    ...
    for stock in stock_list:
        print(stock.symbol," ",end="")
    print("]")
    symbol = input("Pick a stock for the chart: ").upper()
    found = False
...
def display_report(stock_list):
    ...
    for stock in stock_list:
        ...
        for daily_data in stock.DataList:
            ...
            price_change = highPrice - lowPrice
        ...
        if count > 0:
            ...
            print("Change in Price: ${:,.2f}".format(price_change))
            print("Profit/Loss: ${:,.2f}".format(price_change * stock.shares))
        else: 
